...
initial_position_.x = rospy.get_param("initial_x", -0.7)
initial_position_.y = rospy.get_param("initial_y", 0.0)
initial_position_.z = 0
desired_position_ = Point()
desired_position_.x = rospy.get_param("des_pos_x", 2.0)
desired_position_.y = rospy.get_param("des_pos_y", 0.4)
...
def clbk_laser(msg):
    ...
    regions_ = {
        ...
        "front": min(min(msg.ranges[144:235]), 10),
        "fleft": min(min(msg.ranges[236:287]), 10),
    ...
    while not rospy.is_shutdown():
        ...
        if state_ == 0:
            ...
            if (
                ...
                and regions_["front"] > 1.5
                and regions_["fright"] > 1
                and regions_["fleft"] > 1
            ):
                print("less than 30")
                change_state(0)

...
# keep straight
print(phi(0.6, 0.60926, math.radians(10)))

# 5deg inwards
print(phi(0.6, 0.6188, math.radians(10)))

# 5 deg outwards
print(phi(0.6, 0.6, math.radians(10)))

# 10deg inwards
print(phi(0.6, 0.629, math.radians(10)))

# 10 deg outwards
print(phi(0.6, 0.5906, math.radians(10)))

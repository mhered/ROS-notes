...
def spiral_cleaning(velocity_publisher, omega, d_vel):
    ...
    # move to starting point (lower left corner)
    go_to(velocity_publisher=velocity_publisher, goal=(5.5, 5.5))
    time.sleep(WAIT)
    ...
    loop_rate = rospy.Rate(50)  # we publish the velocity at 10 Hz (10 times/s)
...
def grid_cleaning(velocity_publisher, WAIT, LIN_SPEED, ROT_SPEED):
    """Grid cleaning method"""
...
if __name__ == "__main__":
    try:
        ...
        SPIRAL_SPEED = rospy.get_param("SPIRAL_SPEED", 5.0)
        INC_SPEED = rospy.get_param("INC_SPEED", 0.07)

        # Menu
        while True:
            print("1: GRID\n2: SPIRAL\n3: RESET\n4: STOP\n")
            a = input("How would you like to clean today?")

            if a == "1":
                # call the function
                print("Grid cleaning in progress...")
                grid_cleaning(velocity_publisher, WAIT, LIN_SPEED, ROT_SPEED)
                print("Grid cleaning completed!")
            if a == "2":
                # call the function
                print("Spiral cleaning in progress...")
                spiral_cleaning(velocity_publisher, SPIRAL_SPEED, INC_SPEED)
                print("Spiral cleaning completed!")
            if a == "3":
                print("Resetting...")
                time.sleep(1)

...
This generates a [`mymap.pgm`](./assets/images/mymap.pgm) image file and a  [`mymap.yaml`](./assets/images/mymap.yaml) metadata file in the current directory. 
...
Remeber the command to launch SLAM was:
